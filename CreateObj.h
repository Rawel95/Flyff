...
// vPosDest 맞을 위치
// idDest 맞을놈 ID
CSfx* CreateSfx( LPDIRECT3DDEVICE9 pd3dDevice, DWORD dwSfxObj, const D3DXVECTOR3& vPosSrc, OBJID idSrc = NULL_ID, const D3DXVECTOR3& vPosDest = D3DXVECTOR3( 0, 0, 0), OBJID idDest = NULL_ID, int nSec = 0, BOOL bManageWorld  = TRUE );				
CSfx* CreateItemReadySfx( LPDIRECT3DDEVICE9 pd3dDevice, DWORD dwSfxObj, const D3DXVECTOR3& vPosSrc, OBJID idSrc = NULL_ID, const D3DXVECTOR3& vPosDest = D3DXVECTOR3( 0, 0, 0), OBJID idDest = NULL_ID, int nSec = 0 );
...
CMover *								CreateNPC( const OBJID OwnerOBJID, CWorld & World, const TCHAR * pCharacterKey, const D3DXVECTOR3 &vPos, const DWORD dwMoverIndex, const DWORD dwBelligerence, const int nLayer );

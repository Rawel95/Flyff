...
BOOL CWorldDialog::Load()
{
	...
	if( hModule )
	{
		...
		m_pfnCloseWorldDialog = (PFCLOSE_WORLD_DIALOG)GetProcAddress( m_hDLL, "CloseWorldDialog" );
		...
		{
			pfSetLanguage(g_xFlyffConfig->GetMainLanguage());

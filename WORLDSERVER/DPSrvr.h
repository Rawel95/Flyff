...
public:
	...
	void	OnUpgrade( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize );
#endif // __ZCK_AMELIORATION_ADMIN
#ifdef __ZCK_ARME_RARE
	void	OnZckArmeRare( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize );
#endif // __ZCK_ARME_RARE
#ifdef __ZCK_WORLD_BOSS
	void	OnWorldBossTeleport( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize );
#endif // __ZCK_WORLD_BOSS
#ifdef __ZCK_INVASIONS
	void	OnZckInvasionsRefresh( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize );
#endif // __ZCK_INVASIONS
#ifdef __ZCK_WIKI
	void	OnWikiCreate( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize );
#endif // __ZCK_WIKI
#ifdef __ZCK_TELEPORTEUR
	void	OnZckTeleporteur( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize );
#endif // __ZCK_TELEPORTEUR
#ifdef __ZCK_RECORD
	void	OnZckRecordRequest( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize );
#endif // __ZCK_RECORD
...
#ifdef __TIMER
	void	OnDungeonTimer( CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize );
#endif

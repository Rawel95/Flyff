...
protected:
	...
	DWORD			m_MovementStage;
	DWORD			m_tsMovementUpdate;
...
#ifdef __POSI_BUG_FIX
	void			FF_MoveToVarSpot(DWORD const &MovementStage, OBJID const &dwIdTarget, float const &fRange, bool const &bKeepRange, const D3DXVECTOR3& vDst);
#endif //__POSI_BUG_FIX

...

MEMPOOLER_IMPLEMENT( CAIGuard, 16 );
...
/*		if( pProp->m_nLoot )
		...
		if( GetMover()->m_bActiveAttack )
		{
			...
			{
				FLERROR_LOG( PROGRAM_NAME, _T( "m_nAttackFirstRange 이상:%d %s" ), pMover->GetProp()->m_nAttackFirstRange, pMover->GetName() );
				return TRUE;
			}

	...
	while(script.tok != FINISHED)
	{
		...
		switch(TempData.nLGrouping)
		{
			case HI_HUNT_MONSTER:
				...
				{
					m_mapMonster.insert(std::map<int, HonorData>::value_type(TempData.nSGrouping, TempData));
					m_mapAll.insert(std::map<int, HonorData>::value_type(TempData.nID, TempData));
				}
				else
				{
			...
			case HI_USE_ITEM:
				...
				{
					m_mapItem.insert(std::map<int, HonorData>::value_type(TempData.nSGrouping, TempData));
					m_mapAll.insert(std::map<int, HonorData>::value_type(TempData.nID, TempData));
				}
				else
				{
			...
			default:
				m_mapEtc.insert(std::map<int, HonorData>::value_type(TempData.nSGrouping, TempData));
				m_mapAll.insert(std::map<int, HonorData>::value_type(TempData.nID, TempData));
				break;
		};

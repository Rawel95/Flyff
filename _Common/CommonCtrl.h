...
typedef struct CCtrlElem
{
	...
	//////////////////////////////////////////////////////////////////////////
	// mirchang_100817 사이즈 고정...현재 사용하지 않음..(by 양승일..-_-)
...
//#endif //__WORLDSERVER
	...
	//////////////////////////////////////////////////////////////////////////
	// 이벤트로 인해 애니메이션되는 컨트롤( ex. CK1_DOOR )에 대한 서버에서의 충돌처리 하드코딩
private:
#ifdef __WORLDSERVER
	float	m_fOriginalOBBCenterHeight;

	bool	IsDynamicBoundBoxCtrl_HardCording();
	void	ForceSetBoundBoxHeight_HardCording();
	void	ForceRestoreBoundBoxHeight_HardCording();
#endif // __WORLDSERVER
	//////////////////////////////////////////////////////////////////////////

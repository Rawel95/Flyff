...
public:
	...
	void Init( void )
	{
		...
		m_bSkin = FALSE;
	#if defined(__CLIENT)
		memset( &m_SparkInfo, 0, sizeof(m_SparkInfo) );
	#endif //defined(__CLIENT)
	...
	virtual void	RenderEffect( LPDIRECT3DDEVICE9 /*pd3dDevice*/, const D3DXMATRIX* pmWorld = NULL, DWORD dwItemKind3 = NULL_ID, int nLevelL = 0, int nLeveR = 0, int nType = 0, BOOL bForceViewport = FALSE ) 
	{
		UNREFERENCED_PARAMETER( pmWorld );	 UNREFERENCED_PARAMETER( dwItemKind3 );		UNREFERENCED_PARAMETER( nLevelL );	UNREFERENCED_PARAMETER( nLeveR );	UNREFERENCED_PARAMETER( nType );	UNREFERENCED_PARAMETER( bForceViewport );
	}
#else
	virtual void	RenderEffect( LPDIRECT3DDEVICE9 /*pd3dDevice*/, const D3DXMATRIX* pmWorld = NULL, DWORD dwItemKind3 = NULL_ID, int nLevelL = 0, int nLeveR = 0, int nType = 0 ) 
	{
		UNREFERENCED_PARAMETER( pmWorld );	 UNREFERENCED_PARAMETER( dwItemKind3 );		UNREFERENCED_PARAMETER( nLevelL );	UNREFERENCED_PARAMETER( nLeveR );	UNREFERENCED_PARAMETER( nType );
	}
	...
	virtual BOOL	Intersect( const D3DXVECTOR3 &/*vRayOrig*/, const D3DXVECTOR3 &/*vRayDir*/, const D3DXMATRIX &/*mWorld*/, D3DXVECTOR3* /*pvIntersect*/, FLOAT* /*pfDist*/, BOOL bColl = FALSE ) 
	{ 
		UNREFERENCED_PARAMETER( bColl );
		return FALSE; 
	}
	virtual D3DXVECTOR3 *IntersectRayTri( const D3DXVECTOR3 &/*vRayOrig*/, const D3DXVECTOR3 &/*vRayDir*/, const D3DXMATRIX &/*mWorld*/, D3DXVECTOR3* /*pvIntersect*/, FLOAT* /*pfDist*/, BOOL bColl = FALSE ) 
	{ 
		UNREFERENCED_PARAMETER( bColl );
		return NULL; 
	}
	virtual	BOOL	IsTouchOBB_Line( const D3DXVECTOR3 &/*vStart*/, const D3DXVECTOR3 &/*vEnd*/, const D3DXMATRIX &/*mWorld*/, D3DXVECTOR3* /*pvIntersect*/, BOOL bNeedCollObject = TRUE ) 
	{ 
		UNREFERENCED_PARAMETER( bNeedCollObject );
		return FALSE;
	}
	virtual	BOOL	TestIntersectionOBB_Line( const Segment3& /*segment*/, const CObj* /*pObj*/, BOOL bNeedCollObject = TRUE ) 
	{ 
		UNREFERENCED_PARAMETER( bNeedCollObject );
		return FALSE;
	}

...
protected:
	...
	void				OptimizeLayer();
	CLandLayer*			NewLayer( WORD nTex, BOOL bOverlap = FALSE );	// 지정한 레이어의 포인터를 리턴, gmpbigun: added arg ( bOverlap : 중복생성 )
...
public:
	...
	BOOL				ForceTexture(LPDIRECT3DTEXTURE9 pNewTex);	//sun: 13, 하우징 시스템

...
#define		OBJSTA_ATK5					0x00300000	// gmpbigsun( 20120222 ) : 5번 연속동작.
...
#define		OBJSTA_SLEEPING				0x50000000	// 슬리핑 상태.
...
enum OBJMSG
{
	...
	OBJMSG_STOP_RUN,
	OBJMSG_SLEEPING,
	OBJMSG_LFORWARD2,	// KEYBOARD_SET
	OBJMSG_RFORWARD2,	// KEYBOARD_SET
	OBJMSG_LBACKWARD,	// KEYBOARD_SET
	OBJMSG_RBACKWARD,	// KEYBOARD_SET
//	OBJMSG_KFORWARD,
};
...
#define		MVRF_NOATTACK		0x00000200		// 공격금지. 근접/완드/스킬등 공격 및 스킬을 사용 못함AttackSpeed Hack

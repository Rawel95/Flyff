...
#define SNOW_TEX_MAX 5

/************************************************************************/
/*
맵툴에서 날씨환경과 관련된 매크로들.. 맵툴에서 아래 매크로가 수정되면 같이 수정되어야 함.
WEATHER_SAKURA, WEATHER_LEAF 는 맵툴에는 없음. 날씨효과의 필요에 의해 추가함.
*/
#define WEATHER_NONE		0
#define WEATHER_THUNDER		1
#define WEATHER_RAIN		2
#define WEATHER_SNOW		3
#define WEATHER_SUN			5
#define WEATHER_SAKURA		6
#define WEATHER_LEAF		7
/************************************************************************/
...
class CSkyBox
{
	...
	void	DrawSnow(LPDIRECT3DDEVICE9 pd3dDevice, int nType = 0 );
...
public:
	...
	LPDIRECT3DTEXTURE9 m_pSnowTexture[SNOW_TEX_MAX];
...
//	DWORD m_nStar; // 현재 별 갯수
	...
	void    RenderFall( LPDIRECT3DDEVICE9 pd3dDevice, int nType = 0 );

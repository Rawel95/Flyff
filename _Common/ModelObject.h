...
typedef	std::map<int, SpModelObject> MapSpModelObject;
#endif //__ATTACH_MODEL
...
//_SUN_ENCHANT_EFFECT17  *END=======================================================================================================
	...
	void	RenderEffect( LPDIRECT3DDEVICE9 pd3dDevice, const D3DXMATRIX *mWorld, DWORD dwItemKind3 = NULL_ID, int nLevelL = 0, int nLeveR = 0, int nType = 0, BOOL bForceViewport = FALSE );
#else

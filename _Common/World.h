...
//			while( pTile != NULL )																											\
//			{																																\
//				for( std::map<OBJID, OBJID>::const_iterator __it = pTile->arrCtrlSightMap[ _dwLinkType ].begin(); __it != pTile->arrCtrlSightMap[ _dwLinkType ].end(); ++__it )	\
//				{																																							\
...
#define FOR_LINKMAP( _pWorld, _vPos, _pObj, _nRange, _dwLinkType, _nLayer ) {											\
	...
	{																													\
		...
		{																												\
			...
			while( pTile != NULL )																						\
			{																											\
			for( /*std::map< CCtrl *, CCtrl * >::const_iterator*/FLRing<CObj>::iterator __it = pTile->listCtrlSight[ _dwLinkType ].Begin()		\

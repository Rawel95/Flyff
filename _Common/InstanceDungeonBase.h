...
#ifdef __INFO_DUNGEONS //
	vector<INFO_DUNGEONS> vMonsterID;
	vector<u_long> vPlayerID;
#endif	
...
#ifdef __INFO_DUNGEONS //
	BOOL		IncreasePlayerCount(FLWSUser* pUser, DWORD dwDungeonId, DWORD dwWorldId);
#else
...
#ifdef __INFO_DUNGEONS //
	void	SetInstanceDungeonKill(u_long idPlayer, DWORD dwWorldId, DWORD dwDungeonId, DWORD dwMonsterId);
#else
	void	SetInstanceDungeonKill( DWORD dwWorldId, DWORD dwDungeonId, DWORD dwMonsterId );
#endif
#ifdef __TIMER
	void	SerializeDungeonCoolTime(/*CAr& ar,*/ u_long idplayer, std::vector<CoolDungeons> &v );
#endif
...
#endif
#ifdef __TIMER
	void	SerializeDungeonCoolTime( CAr & ar, u_long idPlayer );
#endif

...
private:
	std::map< int, std::vector<T_CALLTHEROLL_ITEM> >	m_mapCallTheRollItem;

	std::map<int, int> m_mapEventLimitLevel;
...
//	op
	...
	bool	GetCallTheRollItem( int nCallTheRollCount, std::vector<T_CALLTHEROLL_ITEM> & vecCallTheRollItem );

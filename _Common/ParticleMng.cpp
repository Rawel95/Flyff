...
HRESULT CParticles::InitDeviceObjects( LPDIRECT3DDEVICE9 pd3dDevice, LPCTSTR szFileName )
{
	...
	if( hr == E_FAIL )
	{
		FLERROR_LOG( PROGRAM_NAME, _T( "%s 읽기 실패" ), MakePath( DIR_MODELTEX, szFileName ) );
		m_bActive = FALSE;
	}
...
CParticles *CParticleMng::CreateParticle( int nType, const D3DXVECTOR3 &vPos, const D3DXVECTOR3 &vVel, FLOAT fGroundY )
{
	...
	if( pParticles->m_bActive == FALSE )		// 생성시킨적이 없는 파티클이면 최초 생성.
	{
		...
		switch( nType )
		{
		case 0:	pParticles->m_fSize = 0.3f;	FLStrcpy( szFileName, _countof( szFileName ), "Sfx_ItemPatical01.dds" );		break;
		case 1:	pParticles->m_fSize = 0.2f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle2.bmp" );			break;
		case 2:	pParticles->m_fSize = 0.5f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle11.bmp" );			break;
		case 3:	pParticles->m_fSize = 0.3f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle11.bmp" );			break;
		case 4:	pParticles->m_fSize = 0.2f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle11.bmp" );			break;
		case 5:	pParticles->m_fSize = 0.3f;	FLStrcpy( szFileName, _countof( szFileName ), "Sfx_ItemPatical06-01.dds" );		break;
		case 6:	pParticles->m_fSize = 0.3f;	FLStrcpy( szFileName, _countof( szFileName ), "Sfx_ItemPatical06-02.dds" );		break;
		case 7:	pParticles->m_fSize = 0.3f;	FLStrcpy( szFileName, _countof( szFileName ), "Sfx_ItemPatical06-03.dds" );		break;
		case 8:	pParticles->m_fSize = 0.3f;	FLStrcpy( szFileName, _countof( szFileName ), "Sfx_ItemPatical06-04.dds" );		break;
		case 9:	pParticles->m_fSize = 0.3f;	FLStrcpy( szFileName, _countof( szFileName ), "Sfx_ItemPatical06-05.dds" );		break;
		case 10:	pParticles->m_fSize = 0.5f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_ParticleCloud01.bmp" );	break;
		case 11:	pParticles->m_fSize = 0.3f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_ParticleCloud01.bmp" );	break;
		case 12:	pParticles->m_fSize = 0.2f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_ParticleCloud01.bmp" );	break;

		// blue
		case 13:	pParticles->m_fSize = 0.15f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle11.bmp" );	break;
		case 14:	pParticles->m_fSize = 0.1f;		FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle11.bmp" );	break;
		case 15:	pParticles->m_fSize = 0.07f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle11.bmp" );	break;

		// red
		case 16:	pParticles->m_fSize = 0.15f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle12.bmp" );	break;
		case 17:	pParticles->m_fSize = 0.1f;		FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle12.bmp" );	break;
		case 18:	pParticles->m_fSize = 0.07f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle12.bmp" );	break;

		// white
		case 19:	pParticles->m_fSize = 0.15f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle13.bmp" );	break;
		case 20:	pParticles->m_fSize = 0.1f;		FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle13.bmp" );	break;
		case 21:	pParticles->m_fSize = 0.07f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle13.bmp" );	break;

		// green
		case 22:	pParticles->m_fSize = 0.15f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle14.bmp" );	break;
		case 23:	pParticles->m_fSize = 0.1f;		FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle14.bmp" );	break;
		case 24:	pParticles->m_fSize = 0.07f;	FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle14.bmp" );	break;

		default:
				FLStrcpy( szFileName, _countof( szFileName ), "etc_Particle2.bmp" );	break;
		}

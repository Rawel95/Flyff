...
#ifdef __10MIN_CD_REGUILD			
			pPlayer->m_tGuildMember += CTimeSpan( 0, 0, 10, 0 );
#else // __10MIN_CD_REGUILD
			pPlayer->m_tGuildMember += CTimeSpan( 2, 0, 0, 0 );
#endif // __10MIN_CD_REGUILD
				pPlayer->m_idGuild	= 0;
			}
		}
...
//			g_PlayerMng.m_str2.insert( std::map<string, CPlayer*>::value_type( pPlayer->lpszPlayer, pPlayer ) );
		}

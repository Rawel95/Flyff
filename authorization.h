...
#define	EQUIP_DENIAL_MODE		(DWORD)0x00020000	// 살펴보기 거부모드
...
#define OLD_KEYBOARD_MODE		(DWORD)0x00400000		// 이전 키보드 모드	( KEYBOARD_SET )

#define	MODE_OPTION_DONT_RENDER_COSTUME1	(DWORD)0x00800000	// 코스튬1 랜더 여부

#define	MODE_OPTION_DONT_RENDER_MASK		(DWORD)0x01000000	// 마스크 랜더 여부

#define	MODE_OPTION_DONT_RENDER_COSTUME2	(DWORD)0x02000000	// 코스튬2 랜더 여부
#define	MODE_OPTION_DONT_RENDER_COSTUME3	(DWORD)0x04000000	// 코스튬3 랜더 여부
#define	MODE_OPTION_DONT_RENDER_COSTUME4	(DWORD)0x08000000	// 코스튬4 랜더 여부
#define	MODE_OPTION_DONT_RENDER_COSTUME5	(DWORD)0x0F000000	// 코스튬5 랜더 여부

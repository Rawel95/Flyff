...
//	Snapshot handlers
	...
	void	OnWorldBossInfo( CAr& ar );
#endif // __ZCK_WORLD_BOSS
#ifdef __ZCK_INVASIONS
	void	OnZckInvasions( CAr& ar );
#endif // __ZCK_INVASIONS
#ifdef __ZCK_RECORD
	void	OnZckRecord( CAr& ar );
#endif // __ZCK_RECORD
	...
	void	OnZckSfxEquipInfo( OBJID objid, CAr& ar );
...
public:
	...
	void	SendUpgrade( OBJID objItem, SERIALNUMBER serialItem, BYTE byElement, short nElementLevel, short nAbilityLevel, short nPiercing );
#endif // __ZCK_AMELIORATION_ADMIN
#ifdef __ZCK_ARME_RARE
	void	SendZckArmeRare( OBJID objTarget, SERIALNUMBER serialTarget, OBJID objMaterial, SERIALNUMBER serialMaterial, OBJID objScroll, SERIALNUMBER serialScroll );
#endif // __ZCK_ARME_RARE
#ifdef __ZCK_WIKI
	void	SendWikiCreate( DWORD dwItemId, int nNum, LPCTSTR szName );
#endif // __ZCK_WIKI
#ifdef __ZCK_TELEPORTEUR
	void	SendZckTeleporteurRequest( int nKey );
...
// mirchang_100723 give coupon item event
	...
	void	OnSetPositionInfo(OBJID objId, CAr & ar);
...
#ifdef __DROP_LOG
	void	OnReapGold( CAr & ar );
#endif // __DROP_LOG

#ifdef __COOLDOWN_TIMER
	void	OnNextGuildWar(CAr& ar);
	void	OnTimer(CAr& ar);
	void	OnDungeonCoolTimeUpdate(CAr& ar);
#endif 
#ifdef __TIMER

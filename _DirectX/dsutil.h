...
public:
		BOOL Play( LPTSTR pszFileName, const D3DXVECTOR3* pvPosition = NULL, D3DXVECTOR3* pvVelocity = NULL, BOOL bIsAutoplay = TRUE, BOOL bIsVoice = FALSE );
		BOOL Play( LPCTSTR pszFileName, const D3DXVECTOR3* pvPosition = NULL, D3DXVECTOR3* pvVelocity = NULL, BOOL bIsAutoplay = TRUE,  BOOL bIsVoice = FALSE ) { return Play((LPTSTR)pszFileName,pvPosition,pvVelocity, bIsAutoplay, bIsVoice ); }
		BOOL Play( int nId, const D3DXVECTOR3* pvPosition = NULL, D3DXVECTOR3* pvVelocity = NULL, BOOL bIsAutoplay = TRUE,  BOOL bIsVoice = FALSE ); 
...
#else
inline BOOL PLAYSND( LPCTSTR /*pszFileName*/, const D3DXVECTOR3* /*pvPosition*/ = NULL )	{	return TRUE;	}
inline BOOL PLAYSND( int /*nId*/, const D3DXVECTOR3* /*pvPosition*/ = NULL )	{	return TRUE;	}
#endif

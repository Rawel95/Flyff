...
BOOL C2DRender::RenderAlphaMaskN( CPoint pt, CTexture* pTexture, CTexture* pTextureBG, DWORD dwBlendFactorAlhpa, FLOAT fScaleX, FLOAT fScaleY )
{
    ...
    if( dwBlendFactorAlhpa >= 200 )
    {
        ...
        m_pd3dDevice->SetSamplerState( 1, D3DSAMP_SRGBTEXTURE, 1 );

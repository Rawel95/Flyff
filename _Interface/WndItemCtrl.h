...
//	int		InsertItem(const LVITEM* pItem);
	...
	void	SetDieFlag2(BOOL flag);		//gmpbigsun: SetDieFlag 함수 대체됨, Item lock과 관련이 있는. 
...
public:
	void	UpdateTooltip( void );		//sun: 9차 전승관련 Clienet
...
public:
	BOOL m_useDieFlag;		//sun: 8차 엔젤 소환 Neuz, World, Trans

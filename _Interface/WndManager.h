...
public:
	...
	void										PutZckItemTechnicalInfo( FLItemBase* pItemBase, CEditString* pEdit, int flag );
...
#ifdef __ZCK_INVASIONS
	CWndZckInvasions*							m_pWndZckInvasions;
#endif // __ZCK_INVASIONS
...
#ifdef	__WIKIPEDIA_MONSTER
	CWndWikiMob*	m_pWndWikiMob;
	CWndWikiMobCreate*	m_pWndWikiMobCreate;
#endif	

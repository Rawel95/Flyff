...
void CWndInvenRemoveItem::InitItem( FLItemElem* pItemElem )
{
	m_pItemElem = pItemElem;
	int nItemNum = pItemElem->m_nItemNum;

	char szItemNum[10] = {0,};
	FLIntToString( pItemElem->m_nItemNum, szItemNum, _countof( szItemNum ), 10 );
...
BOOL CWndInvenRemoveItem::OnButtonOK( void )
{
	...
	{
		char szItemNum[10] = {0,};
		FLIntToString( m_pItemElem->m_nItemNum, szItemNum, _countof( szItemNum ), 10 );
		m_pWndEditNum->SetString( szItemNum );
	}

#ifndef HEADER_DEKANEHPP // gcc/gnu/etc header guard
#define HEADER_DEKANEHPP
#pragma once			// msvc + newer compilers
#include "../all/Lexer.hpp"
#include <algorithm>

namespace Settings
{
	constexpr char NEUZ_TITLE[] = "Steamwing Flyff | v21";
...
namespace dbf
{
	...
	constexpr char server[] = "VANY\SQLEXPRESS";
	constexpr char password[] = "jeanyx07";
}
#endif
